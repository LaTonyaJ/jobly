...
class Company {
  ...
  static async findAll(searchQuery = {}) {
    ...
    if(minEmployees > maxEmployees){
      //Ensure minEmployees is less than maxEmployees
      throw new BadRequestError('Min Employees cant be greater than Max');
    }
    ...
    query += " ORDER BY name";
    console.log(query)
    const compResults = await db.query(query, queryValues);
    return compResults.rows;
  }
